...
const Grainient: React.FC<GrainientProps> = ({
  ...
  useEffect(() => {
    ...
    (programRef.current.uniforms.uColor1 as any).value = new Float32Array(hexToRgb(color1));
    (programRef.current.uniforms.uColor2 as any).value = new Float32Array(hexToRgb(color2));
    (programRef.current.uniforms.uColor3 as any).value = new Float32Array(hexToRgb(color3));
